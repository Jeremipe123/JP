...
const EcoFusionProject = () => {
  return (
    <div className="min-h-screen flex flex-col font-eco">
      <div className="flex-1 bg-cover bg-center" style={ { backgroundImage: 'url(/assets/img/demo/fondo.png)' } }>
          ...
          <header className="flex justify-center md:justify-between items-center bg-black bg-opacity-70 py-8 w-full z-50">
            ...
            <nav className="mr-4">
              <ul className="flex text-white">
                <li className="mx-4"><a href="#" className="transition duration-300 hover:text-orange-500">Inicio</a></li>
                <li className="mx-4"><a href="#" className="transition duration-300 hover:text-orange-500">Servicios</a></li>
                <li className="mx-4"><a href="#" className="transition duration-300 hover:text-orange-500">Testimonios</a></li>
                <li className="mx-4"><a href="#" className="transition duration-300 hover:text-orange-500">Contacto</a></li>
              </ul>
            </nav>
          </header>
        </div>
        ...
        <div className="container mx-auto max-w-7xl py-64">
          <section className="hero text-center text-white">
            ...
            <p className="inline-block bg-[#ff4500] text-white text-xl px-6 py-3 rounded mt-8 hover:bg-gray-800 transition duration-300">¡Comienza Ahora!</p>
          </section>
        </div>
      </div>

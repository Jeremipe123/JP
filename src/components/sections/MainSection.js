...
const MainSection = () => {
  return (
    <section id="inicio" className="hero bg-black bg-cover bg-center text-white py-20">
      <div className="container flex items-center justify-center mx-auto px-4 font-montserrat">
        <div className="hero-text text-center animate-fade-in">
          <h1 className="text-4xl font-bold mt-6 mb-11">Bienvenido a mi página</h1>
